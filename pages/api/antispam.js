...
export function checkSpam(userId, username) {
  ...
  const hourMs = 60 * 60 * 1000; // 1 час в миллисекундах
  ...
  // Проверка на превышение лимита (7 заявок в час)
  ...
  // Добавляем запрос и обновляем время
